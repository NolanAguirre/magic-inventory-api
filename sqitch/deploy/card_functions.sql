...
CREATE FUNCTION magic_inventory.create_magic_card(arg_card_data json) RETURNS magic_inventory.magic_card_type AS $$
  ...
  BEGIN
    ...
    RETURN ROW($1.name, tcg_id, $1.card_set, set_code, set_name, collectors_number, $1.condition, $1.variations)::magic_inventory.magic_card_type;
  END
$$ LANGUAGE PLPGSQL;
...
CREATE FUNCTION magic_inventory.to_inventory_card(arg_magic_card magic_inventory.magic_card_type, arg_quantity INTEGER) RETURNS magic_inventory.inventory_card_type AS $$
  BEGIN
    RETURN (ROW($1.name, $1.tcg_id,$1.card_set, $1.set_code, $1.set_name, $1.collectors_number, $1.condition, $1.variations, $2)::magic_inventory.inventory_card_type);
  END;
$$ LANGUAGE PLPGSQL;
